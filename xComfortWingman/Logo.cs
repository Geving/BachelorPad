    ...
    class Logo
    {
        ...
        public static void DrawLogo(int LogoType = 0)
        {
            ...
            switch (LogoType)
            {
                case 0:
                    {
                        int padSize = (Console.WindowWidth - 77) / 2;
                        if(padSize< 0) padSize = 0; 
                        string space = "".PadLeft(padSize, ' ');
                ...
                case 1:
                    {
                        int padSize = (Console.WindowWidth - 148) / 2;
                        if (padSize < 0) padSize = 0;
                        string space = "".PadLeft(padSize, ' ');
                ...
                case 3:
                    {
                        int padSize = (Console.WindowWidth - 97) / 2;
                        if (padSize < 0) padSize = 0;
                        string space = "".PadLeft(padSize, ' ');
                        Console.WriteLine(space + @"         #####                                            #####  #     #  #####  ####### ####### ");
                        Console.WriteLine(space + @" #    # #     #  ####  #    # ######  ####  #####  ##### #     # ##   ## #     #    #       #    ");
                ...
                case 4:
                    {
                        int padSize = (Console.WindowWidth - 138) / 2;
                        if (padSize < 0) padSize = 0;
                        string space = "".PadLeft(padSize, ' ');
                ...
                case 5:
                    {
                        int padSize = (Console.WindowWidth - 90) / 2;
                        if (padSize < 0) padSize = 0;
                        string space = "".PadLeft(padSize, ' ');
